...
export default function StickyFooter({ totalPrice, onAction, buttonLabel }: StickyFooterProps) {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 w-full md:max-w-md mx-auto bg-white p-4 border-t border-gray-100 z-40 shadow-[0_-8px_16px_rgba(0,0,0,0.04)]">
