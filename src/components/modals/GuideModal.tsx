...
export default function GuideModal({ isOpen, onClose }: GuideModalProps) {
  ...
  const slides = ['Mẫu cà vẹt xe mới (minh họa)', 'Mẫu cà vẹt xe cũ (minh họa)'];
            ...
            >
              <div className="absolute inset-y-0 inset-x-0 w-[200%] flex transition-transform duration-300 ease-in-out" style={{ transform: `translateX(-${currentSlide * 50}%)` }}>
                <div className="w-1/2 shrink-0 flex items-center justify-center relative h-full">
                  <Image src="/assets/ca-vet-moi.webp" alt="Mẫu cà vẹt xe mới (minh họa)" fill className="object-contain" />
                </div>
                <div className="w-1/2 shrink-0 flex items-center justify-center relative h-full">
                  <Image src="/assets/ca-vet-cu.webp" alt="Mẫu cà vẹt xe cũ (minh họa)" fill className="object-contain" />
                </div>
              </div>
